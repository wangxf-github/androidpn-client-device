...
import org.androidpn.connection.ConnectivityReceiver;
import org.androidpn.connection.LogUtil;
import org.androidpn.connection.PhoneStateChangeListener;
...
public class NotificationService extends Service {
    ...
    public void onCreate() {
        ...
        editor.putString(Constants.XMPP_WLANMAC,wifiManager.getConnectionInfo().getMacAddress());
        editor.commit();
